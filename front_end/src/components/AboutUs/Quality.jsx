          ...
          <>
            ...
            <img src={footer2} alt="image" className="lg:w-[150px] lg:h-[150px] ml-2 w-[80px] h-[80px]" />
              ...
              <div className="text-white lg:text-1xl text-sm ml-6  text-shadow-lg  font-serif ">
                ...
                <span className="ml-4 "> / About / Quality</span>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="px-6 md:mx-10">
                    ...
                    <p className=" text-justify mt-6">
                      Company's foray into real estate and construction industry
                      led to the creation of various landmark real estate
                      projects - Supertech Business Tower, Falcon Supertech,
                      Hotel Sultan, Supertech Duplex Town, Hotel Grand Noor,
                      (ROB) Flyover Street lighting. are few examples.
                    </p>
                  </div>
                </div>
                {/* <div className="px-6 md:mx-10"> */}
