...
import m6 from "../../../assets/7.jpeg";
import m7 from "../../../assets/8.jpeg";
...
const Chyanir = () => {
  ...
  const images = [m1, m2, m3,m4,m5,m6,m7]; // Add all image URLs here
  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-gray-200 h-auto">
        ...
        <div className="absolute mt-[500px] lg:bg-black lg:w-full h-[40px] opacity-80">
          <div
        ...
        <div className="bg-white shadow-xl  lg:mx-44 p-2">
          <div className="flex flex-col h-auto lg:mx-12 m-0">
            <div>
              <div className="sm:flex relative lg:absolute flex-col mx-6">
              ...
              <div className="flex justify-between pt-6 pt-6">
                ...
                <div className="bg-green-700 text-white w-[100px] h-[30px] lg:mt-8  rounded-lg flex justify-center items-center mx-8 mt-2">
                  Completed
                </div>
              </div>
