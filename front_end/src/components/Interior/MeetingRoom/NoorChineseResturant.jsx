...
import i1 from '../../../assets/noor1.jpg'

import ImageSlider from "../../ImageSlider";
import Sliderr from "../../Slider";
const NoorChineseRestrant = () => {
  ...
  const images = [i1]; // Add all image URLs here
...
export default NoorChineseRestrant;
